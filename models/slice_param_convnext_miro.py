...
class SliceParamConvNeXtMIRO(nn.Module):
...
def sliceparamconvnext_miro(cfg: Model, freeze: str = None) -> SliceParamConvNeXtMIRO:
    return SliceParamConvNeXtMIRO(config=cfg, freeze=freeze)
