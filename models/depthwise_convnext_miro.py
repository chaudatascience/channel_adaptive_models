...
from models.model_utils import conv1x1, get_module, freeze_
...
class DepthwiseConvNeXtMIRO(nn.Module):
    def __init__(
        self,
        config: Model,
        freeze: str = None,
...
def depthwiseconvnext_miro(cfg: Model, **kwargs) -> DepthwiseConvNeXtMIRO:
    return DepthwiseConvNeXtMIRO(config=cfg, **kwargs)
